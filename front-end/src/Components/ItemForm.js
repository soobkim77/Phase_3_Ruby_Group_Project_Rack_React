    ...
    return (
        <div className="container">
            <Form  onSubmit={props.handleSubmit}>
                ...
                <Form.Input fluid label="Category" name="category" placeholder="Enter item's category..." width={4} />
                <Form.Input fluid label="Price" name="price" placeholder="Enter item price..." width={4} />
                <Form.Input fluid label="Condition" name="condition" placeholder="Enter item condition..." width={4} />
